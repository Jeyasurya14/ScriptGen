...
export default function ErrorState({
  ...
  return (
    <div className="min-h-[calc(100vh-80px)] flex flex-col items-center justify-center p-6 text-center animate-fade-in">
      ...
      <h2 className="font-head font-bold text-2xl text-white mb-3">Generator unavailable</h2>
      <p className="text-white/60 max-w-md mb-8">
        {error.message || "An unexpected error occurred while loading the script generator."}
      </p>
